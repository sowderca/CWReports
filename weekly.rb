...
monday = Chronic.parse('this monday')
today = Chronic.parse('this friday')
...
comps.each do |day|
	...
	closed_FCR = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_closed >= #{@morning} and date_closed < #{@evening}  and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'sleeperk' or  closed_by = 'baileypa' or closed_by = 'washingt') and (Board_Name = 'FCR' or Board_Name = 'SC Comm Services' or Board_Name = 'SC Comm Internal' or Board_Name = 'NC Govt Services' or Board_Name = 'NC Govt Internal' or Board_Name = 'GA Govt Services' or Board_Name = 'GA Govt Internal' or Board_Name = 'SC Govt Services' or Board_Name = 'SC Govt Internal' or Board_Name = 'Infrastructure Team')")
	closed_Comm = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'baileypa' or closed_by = 'washingt') and (Board_Name = 'SC Comm Services' or Board_Name = 'SC Comm Internal')")
	closed_NC = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'baileypa' or closed_by = 'washingt') and (Board_Name = 'NC Govt Services' or Board_Name = 'NC Govt Internal')")
	closed_SC = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'baileypa' or closed_by = 'washingt') and (Board_Name = 'SC Govt Services' or Board_Name = 'SC Govt Internal')")
	closed_GA = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'baileypa' or closed_by = 'washingt') and (Board_Name = 'GA Govt Services' or Board_Name = 'GA Govt Internal')")
	closed_infa = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'baileypa' or closed_by = 'washingt' or closed_by = 'sleeperk') and Board_Name = 'Infrastructure Team'")
	closed_onFCR = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (closed_by= 'sowderca' or closed_by = 'carterma' or closed_by = 'washingt' or closed_by = 'baileypa' or closed_by = 'sleeperk') and Board_Name = 'FCR'")
	...
	wheelhouse_closed = cw_client.run_report_count("reportName" => "Service", "conditions" => "date_entered >= #{@morning} and date_entered < #{@evening} and (Detail_Description contains 'WH1' or Detail_Description contains 'WH2' or Detail_Description contains 'WH3' or Detail_Description contains 'WH4' or Detail_Description contains 'WH5' or Detail_Description contains 'WH6' or Detail_Description contains 'WH7' or Detail_Description contains 'WH8' or Detail_Description contains 'WH9' or Detail_Description contains 'WH10' or Detail_Description contains 'WH11' or Detail_Description contains 'WH12' or Summary contains 'Perf - Memory % Bytes' or Summary contains 'Perf - Processor %' or Summary contains 'Perf -Total CPU Processor Time' or Summary contains 'AV - Disabled' or Summary contains 'AV - Missing' or Summary contains 'PF - 90% Plus Avg CPU' or Summary contains 'missing or stopped' or Summary contains 'IE Memory Usage' or Summary contains 'Print Jobs over Threshold') and (closed_by = 'sowderca' or closed_by = 'carterma' or closed_by = 'betivast' or closed_by = 'baileypa' or closed_by = 'sleeperk' or closed_by = 'washingt')")
