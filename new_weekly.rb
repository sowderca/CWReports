...
tuesday = Chronic.parse('tuesday last week').to_date
saturday = Chronic.parse('saturday last week').to_date
days = tuesday.business_dates_until(saturday)
days.push(saturday)
# Arrays for storing value; Might be a less memory heavy method of doing this ***
opened_comm_array,opened_nc_array,opened_sc_array,opened_ga_array,opened_fcr_array,closed_comm_array,closed_nc_array,closed_sc_array,closed_ga_array,closed_fcr_array,com_team_closed_array,nc_team_closed_array,sc_team_closed_array,ga_team_closed_array,night_opened_comm_array,night_opened_nc_array,night_opened_sc_array,night_opened_ga_array,night_opened_fcr_array,night_closed_comm_array,night_closed_nc_array,night_closed_sc_array,night_closed_ga_array,night_closed_fcr_array = [],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]
days.each do |day|
    array << day.iso8601
end
...
loop do 
    ...
    opened_comm_array.push(opened_Comm) unless opened_Comm.nil? rescue nil
...
loop do 
    ...
    opened_nc_array.push(opened_NC) unless opened_NC.nil? rescue nil
...
loop do 
    ...
    opened_sc_array.push(opened_SC) unless opened_SC.nil? rescue nil
...
loop do 
    ...
    opened_ga_array.push(opened_GA) unless opened_GA.nil? rescue nil
...
loop do 
    ...
    opened_fcr_array.push(opened_FCR) unless opened_FCR.nil? rescue nil
...
loop do 
    ...
    closed_comm_array.push(closed_Comm) unless closed_Comm.nil?   rescue nil
...
loop do 
    ...
    closed_nc_array.push(closed_NC) unless closed_NC.nil? rescue nil
...
loop do 
    ...
    closed_sc_array.push(closed_SC) unless closed_SC.nil? rescue nil
...
loop do 
    ...
    closed_ga_array.push(closed_GA) unless closed_GA.nil? rescue nil
...
loop do 
    ...
    closed_fcr_array.push(closed_FCR) unless closed_FCR.nil? rescue nil
...
loop do 
     ...
     com_team_closed_array.push(comm_closed) unless comm_closed.nil?  rescue nil
...
loop do 
    ...
    nc_team_closed_array.push(nc_closed) unless nc_closed.nil?  rescue nil
...
loop do 
    ...
    sc_team_closed_array.push(sc_closed) unless sc_closed.nil?  rescue nil
...
loop do 
    ...
    ga_team_closed_array.push(ga_closed) unless ga_closed.nil?  rescue nil
...
loop do 
    ...
    night_opened_comm_array.push(night_opened_Comm) unless night_opened_Comm.nil? rescue nil
...
loop do 
    ...
    night_opened_nc_array.push(night_opened_NC) unless night_opened_NC.nil? rescue nil
...
loop do 
    ...
    night_opened_sc_array.push(night_opened_SC) unless night_opened_SC.nil? rescue nil
...
loop do 
    ...
    night_opened_ga_array.push(night_opened_GA) unless night_opened_GA.nil? rescue nil
...
loop do 
    ...
    night_opened_fcr_array.push(night_opened_FCR) unless night_opened_FCR.nil? rescue nil
...
loop do 
    ...
    night_closed_comm_array.push(night_closed_Comm) unless night_closed_Comm.nil?  rescue nil
...
loop do 
    ...
    night_closed_nc_array.push(night_closed_NC) unless night_closed_NC.nil? rescue nil
...
loop do 
    ...
    night_closed_sc_array.push(night_closed_SC) unless night_closed_SC.nil? rescue nil
...
loop do 
    ...
    night_closed_ga_array.push(night_closed_GA) unless night_closed_GA.nil? rescue nil
...
loop do 
    ...
    night_closed_fcr_array.push(night_closed_FCR) unless night_closed_FCR.nil? rescue nil
